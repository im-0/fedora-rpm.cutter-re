...
cd build
%ifarch %{qt5_qtwebengine_arches}
%cmake -DCUTTER_ENABLE_QTWEBENGINE=ON ../src
%else
%cmake -DCUTTER_ENABLE_QTWEBENGINE=OFF ../src
%endif
make %{?_smp_mflags}
...
%changelog
* Wed Jun 26 2019 Riccardo Schirone <rschirone91@gmail.com> - 1.8.0-3
- Update to radare2 3.6.0
